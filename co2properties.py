...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun 27 11:04:59 2020
...
class ServerProperties():
    ...
    internet_traffic = 500. * 10**6 # GB / day
    ...
    power_video_low = energy_intensity_low * video_bandwidth_low
...
class ClientProperties():
    ...
    def plasma(self, area):
        return Device(20 + area * 203,
                      5096 * area,
                      849 * area)

    def ledlcd(self, area):
